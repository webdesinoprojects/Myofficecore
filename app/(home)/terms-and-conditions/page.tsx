...
export default function TermsAndConditionsPage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-justify text-gray-700 leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <p>
          Welcome to <strong>MyCoreOffice Services Private Limited</strong>
          (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          ...
          our website{" "}
          <a
            href="https://mycoreoffice.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-600 underline"
          >
            https://mycoreoffice.com
          </a>{" "}
          (together or individually “Service”) operated by MyCoreOffice Services
          Private Limited.
        </p>
        <p>
        ...
        <p>
          If you do not agree with Agreements, you may not use the Service. Please
          contact us at <strong>info@mycoreoffice.com</strong>.
        </p>
      </section>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p>
          ...
          <strong>info@mycoreoffice.com</strong>.
        </p>
      </section>
...
Any contests, sweepstakes or other promotions (collectively, “Promotions”) made available through Service may be governed by rules that are separate from these Terms of Service. If you participate in any Promotions, please review the applicable rules as well as our Privacy Policy. If the rules for a Promotion conflict with these Terms of Service, Promotion rules will apply.
      ...
      <section className="mt-10 space-y-3">
        ...
        <p>
          No refunds will be issued in any manner whatsoever except in case of
      ...
      <section className="mt-10 space-y-3">
        ...
        <p>
          ...
          MyCoreOffice Services Private Limited. You may not reuse it without
...
<li> Otherwise attempt to interfere with the proper working of Service.</li>
      ...
      <section className="mt-10">
        ...
        <p>
          We may use third-party Service Providers to monitor and analyze Service
          usage.
        </p>
      </section>
      ...
      {/* Minors */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">No Use By Minors</h2>
        <p>
      ...
      <section className="mt-10">
        ...
        <p>
          Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of MyCoreOffice Services Private Limited and its licensors. Service is protected by copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of MyCoreOffice Services Private Limited.
        </p>
      </section>
      ...
      <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to info@MyCoreOffice.com, with the subject line: “Copyright Infringement” and include in your claim a detailed description of the alleged Infringement.</p><br />
      <p>You may be held accountable for damages (including costs and attorneys’ fees) for misrepresentation or bad-faith claims on the infringement of any Content found on and/or through Service on your copyright.</p>
      </section>

      {/* Feedback */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">Error Reporting and Feedback</h2>
       <p>You may provide us either directly at info@MyCoreOffice.com or via third party sites and tools with information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may have development ideas similar to the Feedback; (iii) Feedback does not contain confidential information or proprietary information from you or any third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant Company and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual right to use (including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner and for any purpose.</p>
      </section>

      {/* Links */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">Links To Other Web Sites</h2>
    <p>Our Service may contain links to third party web sites or services that are not owned or controlled by MyCoreOffice Services Private Limited.</p><br />
    <p>MyCoreOffice Services Private Limited has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p><br />
    <p>YOU ACKNOWLEDGE AND AGREE THAT COMPANY SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR INDIRECTLY, FOR ANY DAMAGE OR LOSS CAUSED OR ALLEGED TO BE CAUSED BY OR IN CONNECTION WITH USE OF OR RELIANCE ON ANY SUCH CONTENT, GOODS OR SERVICES AVAILABLE ON OR THROUGH ANY SUCH THIRD PARTY WEB SITES OR SERVICES.</p><br />
    <p>WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY THIRD PARTY WEB SITES OR SERVICES THAT YOU VISIT.</p>
      </section>

      {/* Disclaimer */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">Disclaimer Of Warranty</h2>
...
<p>THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.</p>
  ...
  We may terminate or suspend your account and bar access to Service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of Terms.
      ...
      <section className="mt-10">
        ...
        <p>These Terms shall be governed and construed in accordance with the laws of Delhi (India), which governing law applies to agreement without regard to its conflict of law provisions.</p><br />
 ...
 We reserve the right to withdraw or amend our Service, and any service or material we provide via Service, in our sole discretion without notice. We will not be liable if for any reason all or any part of Service is unavailable at any time or for any period. From time to time, we may restrict access to some parts of Service, or the entire Service, to users, including registered users.
      ...
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">Amendments To Terms</h2>
        <p>
    We may amend Terms at any time by posting the amended terms on this site. It is your responsibility to review these Terms periodically.
      ...
      {/* Acknowledgement */}
      <section className="mt-10">
        <h2 className="text-2xl font-semibold">Waiver And Severability
      ...
      <section className="mt-10">
        ...
        <p>
        Please send your feedback, comments, requests for technical support by email: info@MyCoreOffice.com.
        </p>
      </section>
    </main>
  );
